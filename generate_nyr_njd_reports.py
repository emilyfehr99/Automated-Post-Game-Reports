#!/usr/bin/env python3
"""Generate NYR and NJD team reports and save as images to desktop"""
...
# Pre-calculate clutch rankings ONCE for all teams (this will cache for 6 hours)
print("Pre-calculating league-wide clutch rankings (this may take a minute)...")
print("(This only needs to happen once - will be cached for 6 hours)")
try:
